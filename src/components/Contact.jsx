...
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div class="sm:col-span-2">
        ...
        <div class="relative mt-2.5">
          <div class="absolute inset-y-0 left-0 flex items-center">
            ...
            <select id="country" name="country" class="appearance-none h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
              <option>FR</option>
              <option>CA</option>
              <option>EU</option>
            </select>
    ...
    <div class="mt-10">
      <button type="submit" class="block w-full rounded-md bg-[#49a010] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#90ff47] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Envoyer</button>
    </div>
  </form>
</div>
